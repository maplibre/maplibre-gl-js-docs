...
Use [`text-variable-anchor`](https://maplibre.org/maplibre-gl-style-spec/layers/#layout-symbol-text-variable-anchor) to allow high priority labels to shift position to stay on the map.
