...
import { version as styleSpecVersion } from 'maplibre-gl/src/style-spec/package.json';

import slug from 'slugg';

import redirectStyleSpec from '../util/style-spec-redirect';

class PageShell extends React.Component<PageShellProps> {
    componentDidMount() {
